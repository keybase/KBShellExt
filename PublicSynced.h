// PublicSynced.h : Declaration of the CPublicSynced
...
class ATL_NO_VTABLE CPublicSynced :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CPublicSynced, &CLSID_PublicSynced>,
	public IShellIconOverlayIdentifier,
	public IPublicSynced
{
public:
	CPublicSynced()
	{
...
DECLARE_REGISTRY_RESOURCEID(IDR_PUBLICSYNCED)

DECLARE_NOT_AGGREGATABLE(CPublicSynced)

BEGIN_COM_MAP(CPublicSynced)
	COM_INTERFACE_ENTRY(IPublicSynced)
...
private:
	StatusImpl<KBStatus::publicSynced> _status;
};

OBJECT_ENTRY_AUTO(__uuidof(PublicSynced), CPublicSynced)
